System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, UITransform, Input, KeyCode, input, director, EasyControllerEvent, _dec, _class, _crd, ccclass, property, UI_Joystick;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "d5ca1RyU0hCzYn1hZJ9jXJN", "UI_Joystick", undefined);
      ...
      _export("UI_Joystick", UI_Joystick = (_dec = ccclass('UI_Joystick'), _dec(_class = class UI_Joystick extends Component {
        constructor() {
          super(...arguments);
          this._ctrlRoot = null;
        ...
        onKeyDown(event) {
          ...
          if (keyCode == KeyCode.SPACE) {
            this._scene.emit((_crd && EasyControllerEvent === void 0 ? (_reportPossibleCrUseOfEasyControllerEvent({
              error: Error()
            }), EasyControllerEvent) : EasyControllerEvent).JUMP);
          }
        }
...
//# sourceMappingURL=3df27a57deb96ddb1e85fa187c62f5846919dd9f.js.map